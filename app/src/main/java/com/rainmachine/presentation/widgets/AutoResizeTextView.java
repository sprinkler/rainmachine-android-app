...
/**
 * a textView that is able to self-adjust its font size depending on the min and max size of the
 * font, and its own size.<br/>
 ...
 * It should work fine with most Android versions, but might have some issues on Android 3.1 -
 * 4.04, as setTextSize will only work for the first time. <br/>
 * More info here: https://code.google.com/p/android/issues/detail?id=22493 and here in case you
 * wish to fix it: http://stackoverflow.com/a/21851239/878126
 */
public class AutoResizeTextView extends AppCompatTextView {
    ...
    public AutoResizeTextView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        _minTextSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 12, getResources()
                .getDisplayMetrics());
        ...
        _sizeTester = new SizeTester() {
            ...
            public int onTestSize(final int suggestedSize, final RectF availableSpace) {
                ...
                if (transformationMethod != null) {
                    text = transformationMethod.getTransformation(getText(), AutoResizeTextView
                            .this).toString();
                } else {
                ...
                if (singleLine) {
                    ...
                    final StaticLayout layout = new StaticLayout(text, _paint, _widthLimit,
                            Alignment.ALIGN_NORMAL, _spacingMult, _spacingAdd, true);
    ...
    private void adjustTextSize() {
        ...
        // https://github.com/AndroidDeveloperLB/AutoFitTextView/pull/14
//    post(new Runnable()
//    {
//    @Override
//    public void run()
//      {
        ...
        final int heightLimit = getMeasuredHeight() - getCompoundPaddingBottom() -
...
//    });
    ...
    private void superSetTextSize(int startSize) {
        int textSize = binarySearch(startSize, (int) _maxTextSize, _sizeTester,
                _availableSpaceRect);
        super.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
    }

    private int binarySearch(final int start, final int end, final SizeTester sizeTester, final
    ...
    @Override
    protected void onSizeChanged(final int width, final int height, final int oldwidth, final int
            oldheight) {
