...
public class SeekBarWithMin extends AppCompatSeekBar {
    ...
    public SeekBarWithMin(Context context) {
        super(context);
        init();
    }

    public SeekBarWithMin(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SeekBarWithMin(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected synchronized void onDraw(@NonNull Canvas canvas) {
        ...
        String overlayText = (progress + minValue) + "%";
