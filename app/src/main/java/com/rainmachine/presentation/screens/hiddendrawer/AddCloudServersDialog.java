...
public class AddCloudServersDialog extends DialogFragment {
    ...
    public interface Callback {
        void onDialogAddPositiveClick(CloudServers cloudServers);
    }

    public static AddCloudServersDialog newInstance(Callback callback) {
        AddCloudServersDialog dialog = new AddCloudServersDialog();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.hidden_drawer_add_cloud_servers);
        ...
        builder.setPositiveButton(R.string.hidden_drawer_add, (dialog, id) -> {
    ...
    private void onPositiveButton() {
        ...
        if (isSuccess) {
            CloudServers cloudServers = new CloudServers(key, proxy, validator, push);
            callback.onDialogAddPositiveClick(cloudServers);
