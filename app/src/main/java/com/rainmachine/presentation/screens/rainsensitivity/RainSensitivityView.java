...
public class RainSensitivityView extends ViewFlipper implements SeekBar.OnSeekBarChangeListener {
    ...
    public RainSensitivityView(Context context, AttributeSet attrs) {
        super(context, attrs);
        if (!isInEditMode()) {
    ...
    public void render(RainSensitivityViewModel viewModel) {
        updateSeekBar(viewModel.rainSensitivity);
    }
