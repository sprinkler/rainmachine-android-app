...
public class RestrictedDaysDialogFragment extends DialogFragment {
    ...
    public static RestrictedDaysDialogFragment newInstance(int dialogId, String title,
                                                           String positiveBtn, String[] items,
                                                           boolean[] checkedItemPositions) {
        RestrictedDaysDialogFragment fragment = new RestrictedDaysDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.dialog_restricted_days, null);
        ButterKnife.bind(this, view);

        final String[] items = getArguments().getStringArray("items");
        RestrictedDayAdapter adapter = new RestrictedDayAdapter(getActivity(), Arrays.asList
                (items));
