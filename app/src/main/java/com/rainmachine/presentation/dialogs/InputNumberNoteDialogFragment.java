...
public class InputNumberNoteDialogFragment extends DialogFragment {
    ...
    public interface Callback {
        void onDialogInputNumberNotePositiveClick(int dialogId, int value);

        void onDialogInputNumberNoteCancel(int dialogId);
    }

    public static InputNumberNoteDialogFragment newInstance(int dialogId, String title,
                                                            String positiveBtn, int value,
                                                            String textAfter, int minValue, int
                                                                    maxValue, String note) {
        InputNumberNoteDialogFragment fragment = new InputNumberNoteDialogFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = View.inflate(getContext(), R.layout.dialog_input_number_note, null);
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        callback.onDialogInputNumberNoteCancel(getArguments().getInt("dialogId"));
    }
    ...
    private void onPositiveButton() {
        try {
            ...
            if (value >= minValue && value <= maxValue) {
                callback.onDialogInputNumberNotePositiveClick(getArguments().getInt("dialogId"),
                        value);
